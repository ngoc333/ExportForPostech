...
namespace COM
{
	...
	public class OraDB
	{
		...
		public  DataSet Exe_Select_ProcedureAsync()
		{
			string[] RunUser;
			...
			try
			{
				...
				{
					ComVar._WebSvc.Timeout = TimeOut;
					//Task<DataSet> DS_Ret = ComVar._WebSvc.Ora_Select_ProcedureAsync(RunUser, this.DS_Select);
				}
